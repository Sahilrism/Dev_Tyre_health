...
tire_detect_resnet = load_model("app/tyre_detect_resnet_model_new")
...
def tyre_detection(claimid):
    ...
    # print("This is pred_class Tyre Det: ", output)
...
def find_defect_outside(claimid):
    ...
    new=tyre_detection(claimid)
    print("This is neww",new)
    if new==False:
        return 0
